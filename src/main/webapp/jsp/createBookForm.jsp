...
<%@ page import="java.util.List, com.libraryManagement.web.model.Book, com.libraryManagement.web.model.Author, java.time.format.DateTimeFormatter, java.time.LocalDateTime" %>
<!DOCTYPE html>
<html>
	<head>
				...
				<div class="heading">
					...
					<div class="col-2">
						<form class="form-inline my-2 my-lg-0" action="logout">
							...
							<button class="btn btn-outline-primary my-2 my-sm-0" type="submit">Signout</button>
						</form>
					</div>
			...
			<div id="login-credential">
				<form class="form-horizontal" action="add" method="post">
					...
					<div class="input-row">
						...
						<div class="col-sm-7"><input type="text" name="bookCode" class="form-control"></div>
					</div>
					<div class="input-row">
					...
					<div class="input-row">
						...
						<div class="col-sm-7">
							<!-- <input type="text" name="updatedOn" class="form-control"> -->
							<%!
								DateTimeFormatter dtf = DateTimeFormatter.ofPattern("dd MMMM yyyy");
								LocalDateTime now = LocalDateTime.now();
								String updatedOn = dtf.format(now);
							%>
							<%=updatedOn %>
						</div>
					</div>
